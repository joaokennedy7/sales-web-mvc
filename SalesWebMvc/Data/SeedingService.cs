...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Eduardo Bezerra", "eduardobezerra@gmail.com", new DateTime(1998, 9, 12), 2500.0, d1);
            Seller s2 = new Seller(2, "Joao Guilherme", "joaogui@gmail.com", new DateTime(1998, 10, 11), 4500.0, d1);
            Seller s3 = new Seller(3, "Marco Antonio", "marco@gmail.com", new DateTime(1997, 1, 25), 900.0, d4);
            Seller s4 = new Seller(4, "Wellington Kennedy", "wellington@gmail.com", new DateTime(1974, 9, 14), 7500.0, d2);
            Seller s5 = new Seller(5, "Cristina Souza", "cris@gmail.com", new DateTime(1972, 11, 5), 1900.0, d3);
            Seller s6 = new Seller(6, "Luiz Alexandre", "luiz@gmail.com", new DateTime(1958, 5, 4), 2500.0, d1);
